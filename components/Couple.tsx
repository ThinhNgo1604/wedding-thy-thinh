...
const Couple: React.FC = () => {
  ...
  const groomImg = "https://lh3.googleusercontent.com/pw/AP1GczMaEqOSQLx4ucG7KcfIOJvJkrgqrYmmWw7eYu_aavCWt5b8Th74jk-5xWpApCpMEHuLcGHuimkvf3JJHcp4pyNpu3NTDJIDx2BY9yQu9J7LvR6e9A0o6cYFjNDuvTbb5feSWAF-KxXgcNCuyQuopU4aHQ=w2506-h1662-s-no-gm?authuser=0";
  const brideImg = "https://lh3.googleusercontent.com/pw/AP1GczOzm_p6rkM5pS_RpjzyAbRkmclE0JddNNcorH-pCZ6sGmCinHe-xtU8wa2YjlI_yHA1-LmT2VM8GBbQZiMEYtpuhPXwc1ZIqoG-_xNhF2aGFJi2Jzdq5kIet6iC2aXP2GWNLwptQHeXDwIZHu4L1FVKTw=w1246-h1662-s-no-gm?authuser=0";
